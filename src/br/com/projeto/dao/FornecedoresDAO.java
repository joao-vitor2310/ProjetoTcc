...
public class FornecedoresDAO {
    ...
    public boolean cnpjExiste(String cnpj) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao verificar CNPJ: " + erro);
        }
    ...
    //metodo para listar fornecedores por nome
     ...
     //metodo consultaFornecedores por nome
